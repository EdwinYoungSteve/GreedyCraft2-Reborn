...
var oredictMap as IIngredient[][IOreDictEntry] = {
    <ore:vetheaDisabled> : [<waystones:warp_stone>],
    <ore:vetheaDisabled> : [<waystones:waystone>],
    <ore:vetheaDisabled> : [<waystones:warp_scroll>],
    <ore:vetheaDisabled> : [<bountifulbaubles:wormholemirror>],
    <ore:vetheaDisabled> : [<bountifulbaubles:magicmirror>],
    <ore:vetheaDisabled> : [<bountifulbaubles:potionrecall>],
    <ore:vetheaDisabled> : [<bountifulbaubles:potionwormhole>],
    <ore:vetheaDisabled> : [<utilityworlds:portal_garden>],
    <ore:vetheaDisabled> : [<utilityworlds:portal_void>],
    <ore:vetheaDisabled> : [<draconicevolution:dislocator>],
    <ore:vetheaDisabled> : [<draconicevolution:dislocator_advanced>],
    <ore:vetheaDisabled> : [<botania:flugeleye>],
    <ore:vetheaDisabled> : [<compactmachines3:machine>],
    <ore:vetheaDisabled> : [<compactmachines3:machine:1>],
    <ore:vetheaDisabled> : [<compactmachines3:machine:2>],
    <ore:vetheaDisabled> : [<compactmachines3:machine:3>],
    <ore:vetheaDisabled> : [<compactmachines3:machine:4>],
    <ore:vetheaDisabled> : [<compactmachines3:machine:5>],
    <ore:vetheaDisabled> : [<minecraft:bucket>],
    <ore:vetheaDisabled> : [<minecraft:water_bucket>],
    <ore:vetheaDisabled> : [<minecraft:lava_bucket>],
    <ore:vetheaDisabled> : [<forge:bucketfilled>],
    <ore:vetheaDisabled> : [<thermalexpansion:florb>],
    <ore:vetheaDisabled> : [<thermalexpansion:reservoir>],
    <ore:vetheaDisabled> : [<minecraft:gold_ingot>],
    <ore:vetheaDisabled> : [<appliedenergistics2:material>],
    <ore:vetheaDisabled> : [<minecraft:redstone>],
    <ore:vetheaDisabled> : [<thermalfoundation:material:163>],
    <ore:vetheaDisabled> : [<thermalfoundation:material:128>],
    <ore:vetheaDisabled> : [<tcomplement:cast_clay>],
    <ore:vetheaDisabled> : [<tconstruct:clay_cast>],
    <ore:vetheaDisabled> : [<minecraft:ender_chest>],
    <ore:vetheaDisabled> : [<minecraft:ender_eye>],
    <ore:vetheaDisabled> : [<minecraft:blaze_powder>],
    <ore:vetheaDisabled> : [<minecraft:ender_pearl>],
    <ore:vetheaDisabled> : [<enderstorage:ender_storage>],
    <ore:vetheaDisabled> : [<minecraft:ender_chest>],
    <ore:vetheaDisabled> : [<danknull:dank_null_0>],
    <ore:vetheaDisabled> : [<danknull:dank_null_1>],
    <ore:vetheaDisabled> : [<danknull:dank_null_2>],
    <ore:vetheaDisabled> : [<danknull:dank_null_3>],
    <ore:vetheaDisabled> : [<danknull:dank_null_4>],
    <ore:vetheaDisabled> : [<danknull:dank_null_5>],
    <ore:vetheaDisabled> : [<danknull:dank_null_6>],
    <ore:vetheaDisabled> : [<danknull:dank_null_panel_0>],
    <ore:vetheaDisabled> : [<danknull:dank_null_panel_1>],
    <ore:vetheaDisabled> : [<danknull:dank_null_panel_2>],
    <ore:vetheaDisabled> : [<danknull:dank_null_panel_3>],
    <ore:vetheaDisabled> : [<danknull:dank_null_panel_4>],
    <ore:vetheaDisabled> : [<danknull:dank_null_panel_5>],
    <ore:vetheaDisabled> : [<extrautils2:user>],
    <ore:vetheaDisabled> : [<minecraft:ender_pearl>],
    <ore:vetheaDisabled> : [<minecraft:ender_eye>],
    <ore:vetheaDisabled> : [<minecraft:blaze_powder>],
    <ore:vetheaDisabled> : [<minecraft:blaze_rod>],
    <ore:vetheaDisabled> : [<minecraft:obsidian>],
