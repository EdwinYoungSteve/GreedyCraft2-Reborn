...
AlloySmelter.addRecipe(<additions:taigaddon-cheatieum_ingot> * 2, [<ore:ingotMangisite> * 2, <ore:ingotGhostite>, <ore:ingotManyullyn> * 3], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-idiessite_ingot>, [<ore:ingotSoilium> * 3, <ore:ingotHeavenite>, <ore:ingotAdamant>], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-moltenium_ingot> * 2, [<ore:ingotOsram> * 4, <ore:ingotHeavenite> * 2, <ore:ingotDimensium>], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-ranglium_ingot>, [<ore:ingotIdiessite>, <ore:ingotCheatieum>, <ore:ingotCloudite>], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-godiarite_ingot> * 3, [<ore:ingotAdamant> * 3, <ore:ingotTogrium> * 2, <ore:ingotYoggleseum> * 2], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-rainite_ingot> * 3, [<ore:ingotRanglium> * 2, <ore:ingotIdiessite> * 2, <ore:ingotOneo> * 3], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-panloeseum_ingot> * 3, [<ore:ingotGhostite> * 4, <ore:ingotBreakium>], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-typhoonite_ingot> * 2, [<ore:ingotMoltenium> * 2, <ore:ingotGodiarite> * 2, <ore:ingotXenidium>], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-fallenium_ingot> * 2, [<ore:ingotVanadium> * 2, <ore:ingotGallium> * 3, <ore:ingotFenzium> * 2], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-phoenixite_ingot> * 2, [<ore:ingotFenzium> * 3, <ore:ingotDawnium> * 2], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-depthite_ingot> * 3, [<ore:ingotRainite> * 2, <ore:ingotBreakium> * 4, <ore:ingotGallium> * 2], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-lovaquite_ingot> * 2, [<ore:ingotFallenium> * 2, <ore:ingotMolybdenum> * 2, <ore:ingotLosessium>], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-rangolarite_ingot> * 2, [<ore:ingotPhoenixite> * 3, <ore:ingotDepthite>], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-clearite_ingot> * 3, [<ore:ingotIndium> * 2, <ore:ingotSissidium> * 2, <ore:ingotTyphoonite> * 2], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-wefenium_ingot> * 2, [<ore:ingotLovaquite> * 3, <ore:ingotTtwo> * 2, <ore:ingotTierite>], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-errorite_ingot> * 3, [<ore:ingotAntimony> * 2, <ore:ingotCirclium> * 3, <ore:ingotRangolarite> * 4], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-numbereum_ingot> * 2, [<ore:ingotRapesesium> * 2, <ore:ingotWefenium> * 3], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-babyrite_ingot> * 3, [<ore:ingotGold> * 7, <ore:ingotRubium> * 2, <ore:ingotClearite>], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-leadite_ingot> * 3, [<ore:ingotCirclium> * 2, <ore:ingotTechnetium>, <ore:ingotFallenium> * 6], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-martisite_ingot> * 3, [<ore:ingotCestium> * 4, <ore:ingotLeadite> * 3, <ore:ingotNumbereum> * 3], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-flashite_ingot> * 3, [<ore:ingotFraxinium> * 2, <ore:ingotTreasurite> * 2, <ore:ingotErrorite> * 2], 2000, 10.0f);
AlloySmelter.addRecipe(<additions:taigaddon-overlaite_ingot>, [<ore:ingotMartisite>, <ore:ingotClearite>], 2000, 10.0f);
