...
AlloySmelter.addRecipe(<additions:taigaddon-cthughate_ingot> * 2, [<ore:ingotOsram> * 4, <ore:ingotHeavenite> * 2, <ore:ingotDimensium>], 2000, 10.0f);
...
AlloySmelter.addRecipe(<additions:taigaddon-husturite_ingot> * 2, [<ore:ingotCthugha> * 2, <ore:ingotGodiarite> * 2, <ore:ingotXenidium>], 2000, 10.0f);
...
AlloySmelter.addRecipe(<additions:taigaddon-clearite_ingot> * 3, [<ore:ingotIndium> * 2, <ore:ingotSissidium> * 2, <ore:ingotHusturite> * 2], 2000, 10.0f);
...
AlloySmelter.addRecipe(<additions:taigaddon-flashite_ingot> * 3, [<ore:ingotFraxinium> * 2, <ore:ingotBabyrite> * 2, <ore:ingotErrorite> * 2], 2000, 10.0f);
