...
GameStagesUtil.stageCosmic.addIngredients([
    ...
    <additions:taigaddon-antimony_ingot>,
    <additions:taigaddon-babyrite_ingot>,
    <additions:taigaddon-breakium_ingot>,
    <additions:taigaddon-cestium_ingot>,
    <additions:taigaddon-cheatieum_ingot>,
    <additions:taigaddon-circlium_ingot>,
    <additions:taigaddon-clearite_ingot>,
    <additions:taigaddon-cloudite_ingot>,
    <additions:taigaddon-dawnium_ingot>,
    <additions:taigaddon-depthite_ingot>,
    <additions:taigaddon-dimesium_ingot>,
    <additions:taigaddon-errorite_ingot>,
    <additions:taigaddon-fallenium_ingot>,
    <additions:taigaddon-fenzium_ingot>,
    <additions:taigaddon-flashite_ingot>,
    <additions:taigaddon-fraxinium_ingot>,
    <additions:taigaddon-ghostite_ingot>,
    <additions:taigaddon-godiarite_ingot>,
    <additions:taigaddon-heavenite_ingot>,
    <additions:taigaddon-idiessite_ingot>,
    <additions:taigaddon-indium_ingot>,
    <additions:taigaddon-leadite_ingot>,
    <additions:taigaddon-lighteum_ingot>,
    <additions:taigaddon-losessium_ingot>,
    <additions:taigaddon-lovaquite_ingot>,
    <additions:taigaddon-manarium_ingot>,
    <additions:taigaddon-mangisite_ingot>,
    <additions:taigaddon-martisite_ingot>,
    <additions:taigaddon-moltenium_ingot>,
    <additions:taigaddon-molybdenum_ingot>,
    <additions:taigaddon-numbereum_ingot>,
    <additions:taigaddon-oneo_ingot>,
    <additions:taigaddon-overlaite_ingot>,
    <additions:taigaddon-panloeseum_ingot>,
    <additions:taigaddon-phoenixite_ingot>,
    <additions:taigaddon-rainite_ingot>,
    <additions:taigaddon-ranglium_ingot>,
    <additions:taigaddon-rangolarite_ingot>,
    <additions:taigaddon-rapesesium>,
    <additions:taigaddon-rubium_ingot>,
    <additions:taigaddon-sissidium_ingot>,
    <additions:taigaddon-soilium_ingot>,
    <additions:taigaddon-stripium_ingot>,
    <additions:taigaddon-swinium_ingot>,
    <additions:taigaddon-technetium_ingot>,
    <additions:taigaddon-tierite_ingot>,
    <additions:taigaddon-togrium_ingot>,
    <additions:taigaddon-ttwo_ingot>,
    <additions:taigaddon-typhoonite_ingot>,
    <additions:taigaddon-vanadium_ingot>,
    <additions:taigaddon-waringlium_ingot>,
    <additions:taigaddon-wefenium_ingot>,
    <additions:taigaddon-xenidium_ingot>,
    <additions:taigaddon-yoggleseum_ingot>,
